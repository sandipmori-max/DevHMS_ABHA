...
const TermsAndConsent = ({ onAccept }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 30 }}>
      <Text style={styles.title}>Terms & Conditions & Permissions Consent</Text>
      ...
      <Text style={styles.text}>
        ...
        <Text style={{ color: "#3498db" }}>http://deverp.com/index.aspx?q=aboutus</Text>.
      </Text>
...
const styles = StyleSheet.create({
  ...
  updated: { fontSize: 14, color: "#555", textAlign: "center", marginBottom: 20 },
